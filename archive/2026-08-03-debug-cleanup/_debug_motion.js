(function initMotionPreferences(globalScope, factory) {
  ...
  function getMatchMedia() {
    console.log('globalScope=', typeof globalScope, 'matchMedia=', typeof globalScope.matchMedia); if (typeof globalScope === 'undefined' || !globalScope.matchMedia) return null;
    try {
      return typeof globalScope.matchMedia === 'function' ? globalScope.matchMedia : null;
    } catch (error) {
      return null;
    }
  }
